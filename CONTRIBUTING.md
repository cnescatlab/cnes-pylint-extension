# Contributing to cnes-pylint-extension
First off, thanks for taking the time to contribute!
The following is a set of guidelines for contributing to cnes-pylint-extension, which are hosted in the [Lequal Organization](https://github.com/lequal) on GitHub. 
...
* If the problem started happening recently, **can you reproduce the problem in an older version?** What's the most recent version in which the problem doesn't happen? You can download older versions from [the releases page](https://github.com/lequal/cnes-pylint-extension/releases).
...
To submit en enhancement suggestion, create an issue and provide the following information:
